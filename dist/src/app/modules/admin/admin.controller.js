...
class AdminController {
    constructor() {
        this.getDashboardStats = catchAsync(async (req, res) => {
        ...
        this.getAnalytics = catchAsync(async (req, res) => {
        ...
        this.getAllUsers = catchAsync(async (req, res) => {
        ...
        this.manageUser = catchAsync(async (req, res) => {
        ...
        //     });
        // });
        this.getAllTravelPlans = catchAsync(async (req, res) => {
