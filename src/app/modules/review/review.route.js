...
router.post('/', CheckAuth(Role.USER, Role.ADMIN), validationRequest(createReviewValidation), reviewController.createReview);
router.patch('/:id', CheckAuth(Role.USER, Role.ADMIN), validationRequest(updateReviewValidation), reviewController.updateReview);
