...
class TravelRequestService {
    async createRequest(requesterId, requestData) {
        ...
        if (travelPlan.userId === requesterId) {
            throw new ApiError(StatusCodes.BAD_REQUEST, 'Cannot request to join your own travel plan');
        }
        ...
        if (existingRequest) {
            throw new ApiError(StatusCodes.BAD_REQUEST, 'You have already sent a request for this travel plan');
        }
    ...
    async updateRequestStatus(requestId, receiverId, status) {
        ...
        if (request.status !== RequestStatus.PENDING) {
            throw new ApiError(StatusCodes.BAD_REQUEST, 'This request has already been processed');
        }
